...
class SeedDataCommand extends Command
{
    ...
    private function seedMergeFields(OutputInterface $output, MailingList $list): void
    {
        ...
        $fields = array(
            ...
            array('tag' => 'JOINED', 'name' => 'Join Date', 'type' => 'date'),
            array('tag' => 'WEBSITE', 'name' => 'Website', 'type' => 'url'),
            array('tag' => 'ADDRESS', 'name' => 'Address', 'type' => 'address'),
            array('tag' => 'ZIPCODE', 'name' => 'Zip Code', 'type' => 'zip'),
            array('tag' => 'SCORE', 'name' => 'Score', 'type' => 'number'),
            array('tag' => 'SOURCE', 'name' => 'Source', 'type' => 'radio'),
            array('tag' => 'COUNTRY', 'name' => 'Country', 'type' => 'dropdown'),
            array('tag' => 'IMGURL', 'name' => 'Profile Image', 'type' => 'imageurl'),
        );
        ...
        $members = array(
            array(
                ...
                'merge_fields' => array(
                    ...
                    'BIRTHDAY' => '01/15',
                    'JOINED' => '2024-01-15',
                    'WEBSITE' => 'https://splashsync.com',
                    'ADDRESS' => '28 AV DES COLOMBES',
                    'ZIPCODE' => '33700',
                    'SCORE' => '42',
                    'SOURCE' => 'website',
                    'COUNTRY' => 'France',
